...
set InstallAppApkURL=https://appgallery.cloud.huawei.com/appdl/C107276141?

set AppGalleryOUTPUT=AppGallery.apk
set HmsCoreOUTPUT=HMSCore.apk
set InstallAppOUTPUT=AwakenChaosEra.apk
REM /////////////////////////////////////////////////////////////////////////////
...
if not exist "%InstallAppOUTPUT%" (
	CALL :APKDOWLOADFUNC %InstallAppOUTPUT%, %InstallAppApkURL%, AwakenChaosEra
)
